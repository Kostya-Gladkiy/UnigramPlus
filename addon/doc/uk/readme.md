...
* ALT+1 - Перекидає фокус в список чатів.
* ALT+2 - Перекидає фокус на останнє повідомлення в чаті.
* ALT+3 - Перекидає фокус на мітку " непрочитані повідомлення".
...
* ALT+T - Озвучити назву і статус поточного чату.
...
* ALT+S - Пришвидшити/уповільнити швидкість відтворення голосового повідомлення.
...
* ALT+C - Натискає кнопку "Увімкнути/вимкнути камеру".
* ALT+Q - Натиснути кнопку "Миттєвий перегляд", якщо така міститься в поточному повідомленні.
* ALT+O - Натиснути кнопку "Більше опцій" у відкритому чаті, голосовому чаті, або у вікні дзвінка.
* ALT+M - Відкриває меню навігації.
* control+R - Почати запис голосового повідомлення/надіслати голосове повідомлення.
* control+D - Скасувати запис голосового повідомлення. При подвійному натисненні змінює тип оповіщення початку запису, надсилання і скасування запису голосового повідомлення.
* ALT+U - Змінити рівень озвучення індикаторів виконання.
* delete - Видалити повідомлення або чат.
...
* ALT+3 - Перенести фокус до списку папок чатів.
